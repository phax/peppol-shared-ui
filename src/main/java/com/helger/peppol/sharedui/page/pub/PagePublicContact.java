      ...
      if (aFormErrors.isEmpty ())
      {
        if (StringHelper.isNotEmpty (sHoneyPot))
        {
          ...
          else
          {
            ...
            aEmailData.setSubject ("[" + SharedUIHelper.getApplicationTitle () + "] Contact Form - " + sName);

            final StringBuilder aSB = new StringBuilder ();
            aSB.append ("Contact form from " + SharedUIHelper.getApplicationTitle () + " was filled out.\n\n");
