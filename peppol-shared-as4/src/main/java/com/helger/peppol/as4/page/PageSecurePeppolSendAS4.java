...
public class PageSecurePeppolSendAS4 extends AbstractBootstrapWebPage <WebPageExecutionContext>
{
  ...
  private static final String DEFAULT_SENDER_ID = DEFAULTS ? "iso6523-actorid-upis::9915:test-sender" : null;
  private static final String DEFAULT_RECEIVER_ID = DEFAULTS ? "iso6523-actorid-upis::9915:test-receiver" : null;
